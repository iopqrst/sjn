define(function(require, exports, module) {
	...
	/*
	 * ! jQuery UI - v1.10.3 - 2013-06-08 http://jqueryui.com Includes:
	...
	(function($, undefined) {
		...
		$
				.extend(
						$.ui,
						{
							// $.ui.plugin is deprecated. Use $.widget()
							// extensions instead.
							plugin : {
							...
							hasScroll : function(el, a) {
								...
								// TODO: determine which cases actually cause
								// this to happen
								// if the element doesn't have the scroll set,
	...
	(function($, undefined) {
		...
		$.widget = function(name, base, prototype) {
			...
			if (existingConstructor) {
				$.each(existingConstructor._childConstructors, function(i,
					...
					// redefine the child widget using the same prototype that
					// was
		...
		$.widget.bridge = function(name, object) {
			...
			$.fn[name] = function(options) {
				var isMethodCall = typeof options === "string", args = slice
				...
				.widget(
						"ui.mouse",
						{
							...
							_mouseDown : function(event) {
								...
								// event.target.nodeName works around a bug in
								// IE 8 with
			...
			$
					.each(
							...
							function() {
								...
								// reduce to just the positions without the
								// offsets
			...
			return this
					.each(function() {
						var collisionPosition, using, elem = $(this), elemWidth = elem
								...
								basePosition), myOffset = getOffsets(
						...
						// if the browser doesn't support fractions, then round
				...
				left : function(position, data) {
					...
					if (overLeft < 0) {
						newOverRight = position.left + myOffset + atOffset
								+ offset + data.collisionWidth - outerWidth
								- withinOffset;
				...
				top : function(position, data) {
					...
					if (overTop < 0) {
						newOverBottom = position.top + myOffset + atOffset
								+ offset + data.collisionHeight - outerHeight
								- withinOffset;
				...
				.widget(
						...
						$.ui.mouse,
						{
							...
							_mouseStart : function(event) {
								...
								// the actual position calculation - only used
								...
								// inform the manager that dragging has started
								// (see #5003)
								if ($.ui.ddmanager) {
							...
							_mouseDrag : function(event, noPropagation) {
								// reset any necessary cached properties (see
								// #5009)
								...
								// resulting position if something is returned
								if (!noPropagation) {
									var ui = this._uiHash();
							...
							_mouseStop : function(event) {
								...
								// if the original element is no longer in the
								// DOM don't bother to continue (see #8269)
								if (this.options.helper === "original"
										&& !$.contains(
							...
							_mouseUp : function(event) {
								...
								// If the ddmanager is used for droppables,
								// inform the manager that dragging has stopped
								// (see #5003)
								if ($.ui.ddmanager) {
							...
							_getParentOffset : function() {
								...
								// modify a offset calculated on start, since
								...
								// the document, which means that
								// the scroll is included in the initial
								// calculation of the offset of the parent, and
								// never recalculated upon drag
							...
							_generatePosition : function(event) {
								...
								// If we are not dragging yet, we won't check
								// for options
								if (this.originalPosition) {
									if (this.containment) {
										if (this.relative_container) {
											co = this.relative_container
													.offset();
											containment = [
													this.containment[0]
															+ co.left,
									...
									if (o.grid) {
										...
										// prevent divide by 0 error causing
										// invalid argument errors in IE (see
										// ticket #6950)
				...
				.add(
						...
						"connectToSortable",
						{
							...
							stop : function(event, ui) {
								...
								// the stop event of the sortable, but also
								// remove helper
	...
	(function($, undefined) {
		...
		$.ui.ddmanager = {
			...
			dragStart : function(draggable, event) {
				...
				// the position of the droppables can be recalculated (see
				// #5003)
			...
			dragStop : function(draggable, event) {
				...
				// return scroll events when overflow was caused by drag (see
				// #5003)
				if (!draggable.options.refreshPositions) {
					$.ui.ddmanager.prepareOffsets(draggable, event);
				}
						...
						$.ui.mouse,
						{
							...
							_create : function() {
								...
								if (this.element[0].nodeName
									...
									// wrapper to the new current internal
									// element
									this.element
											.wrap($(
								...
								if (this.handles.constructor === String) {
									...
									for (i = 0; i < n.length; i++) {
										...
										// Apply zIndex to all handles - see
										// #7960
										axis.css({
											zIndex : o.zIndex
										});
								...
								this._renderAxis = function(target) {
									...
									for (i in this.handles) {
										...
										// not anything to be executed left
							...
							_destroy : function() {
								...
								var wrapper, _destroy = function(exp) {
									$(exp)
											...
											.removeData("ui-resizable").unbind(
													".resizable").find(
													".ui-resizable-handle")
											.remove();
								};
							...
							_mouseDrag : function(event) {
								...
								// Put this in the mouseDrag handler since the
								// user can start pressing shift while resizing
								...
								// Call the user callback if the element was
								// resized
							...
							_updateVirtualBoundaries : function(
								...
								if (this._aspectRatio || forceAspectRatio) {
									...
									// First, compute the "projected" size for
									// each dimension based on the aspect ratio
									// and other dimension
							...
							_respectSize : function(data) {
								...
								var o = this._vBoundaries, a = this.axis, ismaxw = isNumber(data.width)
										&& o.maxWidth
										&& (o.maxWidth < data.width), ismaxh = isNumber(data.height)
										&& o.maxHeight
							...
							_mouseDrag : function(event) {
								...
								this.selectees
										.each(function() {
											...
											// selected if appendTo: selectable
											if (!selectee
						...
						$.ui.mouse,
						{
							...
							_setOption : function(key, value) {
								if (key === "disabled") {
									...
									// disable as it adds ui-state-disabled
									// class
									$.Widget.prototype._setOption.apply(this,
											arguments);
								}
							...
							_mouseStart : function(event, overrideHandle,
								...
								// because the refreshItems call has been moved
								// to mouseCapture
								...
								// the helper's position to absolute
							...
							_mouseDrag : function(event) {
								...
								for (i = this.items.length - 1; i >= 0; i--) {
									...
									// "sub-sortables" can cause the placeholder
									// to jitter
									...
									// no useless actions that have been done
									// before
									// no action if the item moved is the parent
									// of the item checked
							...
							_createPlaceholder : function(that) {
								...
								if (!o.placeholder
									...
									o.placeholder = {
										...
										update : function(container, p) {
											...
											// actual height by itself (without
											// styles coming from a stylesheet),
											// it receives the inline height
											// from the dragged item
											if (!p.height()) {
												p
								...
								that.placeholder = $(o.placeholder.element
										.call(that.element, that.currentItem));
							...
							_contactContainers : function(event) {
								...
								for (i = this.containers.length - 1; i >= 0; i--) {
									...
									if (this
										...
										// and it's more "inner" than this, then
										// continue
								...
								if (this.containers.length === 1) {
									...
									// find the item with the least distance and
									...
									itemWithLeastDistance ? this._rearrange(
											event, itemWithLeastDistance, null,
											true)
											: this
													._rearrange(
															event,
							...
							_generatePosition : function(event) {
								...
								// only happens for relative elements:
								...
								// the scroll so there are no jumps
								if (this.cssPosition === "relative"
							...
							_clear : function(event, noPropagation) {
								...
								// to after the point where the placeholder has
								// been removed and
								// everything else normalized again
								var i, delayedTriggers = [];

								// We first have to update the dom position of
								// the actual currentItem
				...
				.widget(
						"ui.accordion",
						{
							...
							_create : function() {
								...
								// don't allow collapsible: false and active:
								// false / null
							...
							_setOption : function(key, value) {
								if (key === "active") {
									// _activate() will handle invalid values
									// and update this.options
							...
							_setupEvents : function(event) {
								...
								this
										._off(this.headers.add(this.headers
												.next()));
							...
							_toggle : function(data) {
								...
								// if we're opening from collapsed state, remove
								// the previous header from the tab order
							...
							_animate : function(toShow, toHide, data) {
								...
								// fall back from options to animation in case
								// of partial down settings
				...
				.widget(
						"ui.autocomplete",
						{
							...
							_create : function() {
								...
								// Unfortunately the code for & in keypress is
								// the same as the up arrow,
								...
								isTextarea ? true :
								// Inputs are always single-line, even if inside
								...
								this._on(this.element, {
									keydown : function(event) {
										...
										default:
											suppressKeyPressRepeat = true;
											// search timeout should be
											// triggered before the input value
											// is changed
									...
									keypress : function(event) {
										...
										// replicate some key handlers to allow
										// them to repeat in Firefox and Opera
										var keyCode = $.ui.keyCode;
										switch (event.keyCode) {
										case keyCode.PAGE_UP:
											this._move("previousPage", event);
							...
							__response : function(content) {
								...
								if (!this.options.disabled && content
									...
									// use ._close() instead of .close() so we
									// don't cancel future searches
									this._close();
								}
							},
							...
							_resizeMenu : function() {
								...
								// Firefox wraps long text (possibly a rounding
								// bug)
							...
							_keyEvent : function(keyEvent, event) {
								if (!this.isMultiLine
									...
									// prevents moving cursor to beginning/end
									// of the text field in some browsers
									event.preventDefault();
								}
							}
						});
						...
						"ui.button",
						{
							...
							_create : function() {
								...
								if (toggleButton) {
									...
									// if mouse moves between mousedown and
									// mouseup (drag) set clickDragged flag
									// prevents issue where button state changes
									// but checkbox/radio checked state
								...
								if (this.type === "checkbox") {
									...
									this.buttonElement.bind("click"
										...
										radioGroup(radio).not(radio).map(
												function() {
													return $(this).button(
															"widget")[0];
												}).removeClass(
									...
									this.buttonElement
											...
											// see #8559, we bind to blur here
											// in case the button element loses
											// focus between keydown and keyup,
											// it would be left in an "active"
											// state
											.bind(
													"keyup"
															+ this.eventNamespace
				...
				.extend(
						Datepicker.prototype,
						{
							...
							_connectDatepicker : function(target, inst) {
								...
								// datepicker once it has been attached to the
							...
							_autoSize : function(inst) {
								if (this._get(inst, "autoSize") && !inst.inline) {
									...
									inst.input.attr("size", this._formatDate(
											inst, date).length);
								}
							},
							...
							_optionDatepicker : function(target, name, value) {
								...
								if (inst) {
									...
									// if dateFormat changes and a new
							...
							_doKeyDown : function(event) {
								...
								if ($.datepicker._datepickerShowing) {
														...
														(event.ctrlKey ? -$.datepicker
																...
																: -$.datepicker
																		._get(
																				...
																				"stepMonths")),
														"M");
										break; // previous month/year on page
									// up/+ ctrl
									case 34:
										$.datepicker
												._adjustDate(
									...
									case 38:
										...
										handled = event.ctrlKey
												|| event.metaKey;
										break; // -1 week on ctrl or command
									// +up
									case 39:
										if (event.ctrlKey || event.metaKey) {
											$.datepicker._adjustDate(
									...
									default:
										...
										&& event.ctrlKey) { // display the date
									// picker on
									// ctrl+home
							...
							_doKeyPress : function(event) {
								...
								if ($.datepicker._get(inst, "constrainInput")) {
									chars = $.datepicker
											._possibleChars($.datepicker._get(
													inst, "dateFormat"));
									chr = String
							 ...
							 * If false returned from beforeShow event handler
							 * do not show. @param input element - the input
							 * field attached to the date picker or event - if
							 * triggered by focus
							 */
							...
							_updateDatepicker : function(inst) {
								this.maxRows = 4; // Reset the max number of
								// rows being displayed (see
								// #7043)
							...
							_checkOffset : function(inst, offset, isFixed) {
								...
								// window viewport - move to a better place if
								// so.
								offset.left -= Math
										.min(
												offset.left,
							...
							_setDateFromField : function(inst, noDefault) {
								...
								inst.currentMonth = (dates ? date.getMonth()
										: 0);
								inst.currentYear = (dates ? date.getFullYear()
										: 0);
		...
		$.fn.datepicker = function(options) {
			...
			return this.each(function() {
				typeof options === "string" ? $.datepicker["_" + options
						...
						.concat(otherArgs)) : $.datepicker._attachDatepicker(
						this, options);
			});
		};
						...
						"ui.dialog",
						{
							...
							_create : function() {
								...
								this.originalPosition = {
									...
									index : this.element.parent().children()
											.index(this.element)
								};
							...
							_appendTo : function() {
								...
								return this.document.find(element || "body")
										.eq(0);
							},
							...
							_focusTabbable : function() {
								...
								// [autofocus]
								// 2. Tabbable element inside the content
								// element
							...
							_createTitlebar : function() {
								...
								uiDialogTitle = $("<span>").uniqueId()
										.addClass("ui-dialog-title").prependTo(
							...
							_size : function() {
								...
								// divs will both have width and height set, so
						...
						"ui.menu",
						{
							...
							_create : function() {
								...
								this.element
										...
										// need to catch all clicks on disabled
										// menu
								...
								this
										._on({
											// Prevent focus from sticking to
											// links inside menu after clicking
											// them (focus should always stay on
											...
											"click .ui-menu-item:has(a)" : function(
												...
												if (!this.mouseHandled
													...
													if (target.has(".ui-menu").length) {
														...
														// on the top level, let
														// it stay active.
														// Otherwise, blur the
														// active item since it
											...
											"mouseenter .ui-menu-item" : function(
												...
												// from siblings of the newly
												// focused menu item
												// to avoid a jump caused by
												// adjacent elements both having
								...
								// Clicks outside of a menu collapse any open
								// menus
							...
							_keydown : function(event) {
								...
								default:
									...
									// to move down the menu to the first item
							...
							refresh : function() {
								...
								menus.children(":not(.ui-menu-item):has(a)")
										...
										.uniqueId().addClass("ui-corner-all")
										.attr({
											tabIndex : -1,
											role : this._itemRole()
										});

								// Initialize unlinked menu-items containing
								// spaces and/or dashes only as dividers
								menus
								...
								// Add aria-disabled attribute to any disabled
								// menu item
							...
							focus : function(event, item) {
								...
								focused = this.active.children("a").addClass(
										"ui-state-focus");
								// Only update aria-activedescendant if there's
								// a role
							...
							_startOpening : function(submenu) {
								...
								// Don't open if already open fixes a Firefox
								// bug that caused a .5 pixel
								// shift in the submenu position when mousing
								// over the carat icon
							...
							collapseAll : function(event, all) {
								...
								this.timer = this._delay(function() {
									...
									// If we found no valid submenu ancestor,
									// use the main menu to close all sub menus
									// anyway
							...
							// With no arguments, closes the currently active
							// menu - if nothing is active
							// it closes all menus. If passed an argument, it
							// will search for menus BELOW
							...
							select : function(event) {
								// TODO: It should never be possible to not have
								// an active item at this
							...
							_create : function() {
								...
								this.element
										...
										.attr({
											...
											// aria-valuenow and aria-valuemax
											// are
				...
				.widget(
						...
						$.ui.mouse,
						{
							...
							_setupEvents : function() {
								var elements = this.handles.add(this.range)
										.filter("a");
								this._off(elements);
							...
							_mouseDrag : function(event) {
								...
								this
										._slide(event, this._handleIndex,
												normValue);
						...
						"ui.spinner",
						{
							...
							_events : {
								...
								"mousedown .ui-spinner-button" : function(event) {
									...
									// when the input first received focus. If
									// the input is not focused
									// then we need to set this.previous based
									// on the value before spinning.
									...
									function checkFocus() {
										...
										if (!isActive) {
											...
											this.previous = previous;
											// support: IE
											// IE sets focus asynchronously, so
											// we need to check if focus
											// moved off of the input because
									...
									// ignore the blur event
									// and check (again) if focus moved off of
									// the input.
									this.cancelBlur = true;
									this._delay(function() {
										delete this.cancelBlur;
								...
								"mouseenter .ui-spinner-button" : function(
										event) {
									// button will add ui-state-active if mouse
									// was down while mouseleave and kept down
								...
								// TODO: do we really want to consider this a
								// stop?
							...
							_draw : function() {
								...
								this.buttons = uiSpinner.find(
										".ui-spinner-button").attr("tabIndex",
										-1).button().removeClass(
										"ui-corner-all");
							...
							_adjustValue : function(value) {
								...
								aboveMin = Math.round(aboveMin / options.step)
										* options.step;
								// - rounding is based on 0, so adjust back to
								// our base
								value = base + aboveMin;
							...
							_setOption : function(key, value) {
								if (key === "culture" || key === "numberFormat") {
									var prevValue = this._parse(this.element
											.val());
									this.options[key] = value;
							...
							_destroy : function() {
								this.element.removeClass("ui-spinner-input")
										.prop("disabled", false).removeAttr(
				...
				.widget(
						"ui.tabs",
						{
							...
							_create : function() {
								...
								this.element
										...
										.toggleClass("ui-tabs-collapsible",
												options.collapsible)
										// Prevent users from focusing disabled
										// tabs via click
										.delegate(
												".ui-tabs-nav > li",
												"mousedown"
										...
										// We don't have to worry about focusing
										// the previously focused
										// element since clicking on a
										// non-focusable element should focus
										// the body anyway.
										.delegate(
												".ui-tabs-anchor",
												"focus" + this.eventNamespace,
							...
							_tabKeydown : function(event) {
								...
								// Focus the appropriate tab, based on which key
								// was pressed
								event.preventDefault();
								clearTimeout(this.activating);
								...
								if (!event.ctrlKey) {
									// Update aria-selected immediately so that
									// AT think the tab is already selected.
									// Otherwise AT may confuse the user by
									// stating that they need to activate the
									// tab,
									// but the tab will already be activated by
									// the time the announcement finishes.
							...
							// Alt+page up/down moves focus to the previous/next
							// tab (and activates)
							...
							refresh : function() {
								...
								// get disabled tabs from class attribute from
								// HTML
								...
								this.anchors
										.each(function(i, anchor) {
											var selector, panel, panelId, anchorId = $(
													...
													"id"), tab = $(anchor)
													.closest("li"), originalAriaControls = tab
													.attr("aria-controls");
							...
							// allow overriding how to find the list for rare
							// usage scenarios (#7715)
							_getList : function() {
							...
							_toggle : function(event, eventData) {
								...
								// If we're switching tabs, remove the old tab
								// from the tab order.
								// If we're opening from collapsed state, remove
								// the previous tab from the tab order.
								// If we're collapsing, then keep the collapsing
								// tab in the tab order.
								if (toShow.length && toHide.length) {
							...
							_getIndex : function(index) {
								...
								// a href string instead of a numerical index.
							...
							enable : function(index) {
								...
								if (index === undefined) {
									...
									if ($.isArray(disabled)) {
										...
										disabled = $.map(this.tabs, function(
												li, num) {
						...
						"ui.tooltip",
						{
							...
							options : {
								content : function() {
									...
									// .text() can't accept undefined, so coerce
									// to a string
							...
							_create : function() {
								...
								this.tooltips = {};
								// IDs of parent tooltips where we removed the
								// title attribute
								this.parents = {};
							...
							open : function(event) {
								...
								// kill parent tooltips, custom or native, for
								// hover
								...
								content = contentOption
										.call(
												...
												function(response) {
													...
													// IE may instantly serve a
													// cached response for ajax
													// requests
													// delay this call to _open
													// so the other call to
													// _open runs first
													that
															._delay(function() {
																// jQuery
							...
							_open : function(event, target, content) {
								...
								// native tooltip
								// we have to check first to avoid defining a
								...
								// accessible attributes. For mouse events, set
								// to empty string to avoid
							...
							close : function(event) {
								...
								// disabling closes the tooltip, so we need to
								// track when we're closing
							...
							_destroy : function() {
								...
								$
										.each(
												this.tooltips,
												function(id, element) {
													// Delegate to close method
													// to handle common cleanup
													var event = $.Event("blur");
													event.target = event.currentTarget = element[0];
													that.close(event, true);
	...
	(function($, undefined) {
		 ...
		 * 
		 * Copyright 2013 jQuery Foundation and other contributors Released
		...
		(function(jQuery, undefined) {
					...
					},
					{
						...
						parse : function(execResult) {
							return [ execResult[1] * 2.55,
									execResult[2] * 2.55, execResult[3] * 2.55,
									execResult[4] ];
						}
					},
					{
			...
			function stringParse(string) {
				...
				if (rgba.length) {
					...
					// if this came from a parsed string, force "transparent"
					// when alpha is 0
					...
					.extend(
							color.prototype,
							{
								parse : function(red, green, blue, alpha) {
									...
									if (type === "array") {
										each(spaces.rgba.props, function(key,
												prop) {
											rgba[prop.idx] = clamp(
													red[prop.idx], prop);
										});
			...
			spaces.hsla.to = function(rgba) {
				...
				// saturation = 0%
				// otherwise, saturation is based on the ratio of chroma (diff)
				// to lightness (add)
				if (diff === 0) {
					s = 0;
				} else if (l <= 0.5) {
			...
			$.effects.animateClass = function(value, duration, easing, callback) {
				...
				return this
						.queue(function() {
							...
							// map all animated objects again - calculate new
							// styles and diff
							allAnimations = allAnimations.map(function() {
							...
							$.when.apply($, allAnimations.get()).done(
									function() {
										...
										// this is guarnteed to be there if you
										// use jQuery.speed()
			...
			$.extend($.effects,
					{
						...
						restore : function(element, set) {
							...
							for (i = 0; i < set.length; i++) {
								if (set[i] !== null) {
									...
									// jQuery 1.6.2 incorrectly returns
									// undefined for any falsy value.
									// We can't differentiate between "" and 0
									// here, so we just assume
									// empty string since it's likely to be a
									// more common value...
									if (val === undefined) {
										val = "";
									}
						...
						createWrapper : function(element) {
							...
							// Store the size in case width/height are defined
							// in % - Fixes #5245
							size = {
								width : element.width(),
								height : element.height()
		...
		(function() {
			...
			$.each([ "Quad", "Cubic", "Quart", "Quint", "Expo" ], function(i,
					name) {
		...
		$.effects.effect.explode = function(o, done) {
			...
			for (i = 0; i < rows; i++) { // ===>
				...
				for (j = 0; j < cells; j++) { // |||
					...
					// Create a clone of the now hidden main element that will
					// be absolute positioned
					// within a wrapper div off the -left and -top equal to size
					// of our pieces
					...
					// where the original was located +left and +top equal to
					// the size of pieces
	...
	(function($, undefined) {
		...
		$.effects.effect.highlight = function(o, done) {
			var elem = $(this), props = [ "backgroundImage", "backgroundColor",
					"opacity" ], mode = $.effects.setMode(elem, o.mode
					|| "show"), animation = {
	...
	(function($, undefined) {
		...
		$.effects.effect.pulsate = function(o, done) {
			var elem = $(this), mode = $.effects
					.setMode(elem, o.mode || "show"), show = mode === "show", hide = mode === "hide", showhide = (show || mode === "hide"),
	...
	(function($, undefined) {
		...
		$.effects.effect.puff = function(o, done) {
			var elem = $(this), mode = $.effects
					.setMode(elem, o.mode || "hide"), hide = mode === "hide", percent = parseInt(
