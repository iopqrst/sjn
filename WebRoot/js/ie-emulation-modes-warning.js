...
(function() {
	...
	function actualNonEmulatedIEMajorVersion() {
		// Detects the actual version of IE in use, even if it's in an older-IE
		// emulation mode.
		...
		var jscriptVersion = new Function(
				'/*@cc_on return @_jscript_version; @*/')() // jshint
															// ignore:line
		...
		return jscriptVersion // IE9 or IE10 in any mode, or IE11 in non-IE11
								// mode
	}
